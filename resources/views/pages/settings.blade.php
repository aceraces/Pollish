        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><embed data-fb="login-button" id = "fb_login" scope="public_profile,email" onlogin="checkLoginState();" /></li>
...
<div class="jumbotron" id = "jumbotron_logged_in">
    <div class="container text-center">
        <h2>SETTINGS</h2>
        <a href="/profile" type="button" class="btn btn-primary btn-lg btn-block">PROFILE</a>
        <a href="/existing_polls" type="button" class="btn btn-primary btn-lg btn-block">EXISTING POLLS</a>
        <a href="/create_poll" type="button" class="btn btn-primary btn-lg btn-block">CREATE POLL</a>
